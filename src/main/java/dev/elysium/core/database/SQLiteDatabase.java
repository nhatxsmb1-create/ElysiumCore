...
public class SQLiteDatabase extends DatabaseManager {
    ...
    private void bind(PreparedStatement ps, ElysiumPlayer p) throws SQLException {
        ...
        ps.setDouble(3,  p.getBalance());
        ps.setInt(4,     p.getPlayerPoints());
        ps.setString(5,  p.getPlayerClass());
        ps.setInt(6,     p.getLevel());
        ps.setLong(7,    p.getExp());
        ps.setInt(8,     p.getMana());
        ps.setInt(9,     p.getMaxMana());
        ps.setString(10, p.getGuild());
        ps.setString(11, p.getIsland());
        ps.setInt(12,    p.getBattlePassLevel());
        ps.setInt(13,    p.getSeason());
        ps.setLong(14,   p.getFirstJoin());
